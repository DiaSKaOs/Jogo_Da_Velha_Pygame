...
def desenhar_tabu():
    pygame.draw.line(tela, (255, 211, 155), (200, 0), (200, 600), 10)
    pygame.draw.line(tela, (255, 211, 155), (400, 0), (400, 600), 10)
    pygame.draw.line(tela, (255, 211, 155), (0, 200), (600, 200), 10)
    pygame.draw.line(tela, (255, 211, 155), (0, 400), (600, 400), 10)
    
def desenhar_peca(pos):
    global VEZ
    x, y = pos
    if VEZ == 'JOGADOR2':
        pygame.draw.circle(tela, (0, 0, 255), pos, 50) #Desenho do circulo e definição de cor 
    else:
...
def texto_vitoria(v):
    ...
    if v == 'EMPATE':
        mens_vitoria = arial.render('DEU VELHA', True, (189, 252, 201), 0) #Cor do "DEU VELHA"
        tela.blit(mens_vitoria, (115, 265))
    else:
        mens_vitoria = arial.render(mensagem, True, (189, 252, 201), 0) #Cor do "Jogador tal Venceu"
...
def pontos(pontos1, pontos2):
    ...
    jd1 = arial.render(jogador1, True, (135, 206, 250))
    jd2 = arial.render(jogador2, True, (135, 206, 250))
    tela.blit(jd1, (0, 0))
    tela.blit(jd2, (420, 0))
